            ...
            <ul className="mega-menu">
              <li>
                <ul>
                  ...
                  <li>
                    <Link to={process.env.PUBLIC_URL + "/herrajes"}>
                      {strings["shop_grid_standard-1"]}
                    </Link>
                  </li>
                  <li>
                    <Link to={process.env.PUBLIC_URL + "/tableros"}>
                      {strings["shop_grid_standard-2"]}
                    </Link>
                  </li>
                  <li>
                    <Link to={process.env.PUBLIC_URL + "/maderas"}>
                      {strings["shop_grid_standard-3"]}
                    </Link>
                  </li>
                  {/* <li>
